...
class CustomUser(AbstractUser):
    ...
    REQUIRED_FIELDS = ['email', 'password', 'username', 'userType'] #EMAIL AND PASSWORD ARE REQUIRED BY DEFAULT --> É AQUI QUE SE COLOCAM OS ATRIBUTOS QUE SAO UTILIZADOS NA CRIACAO DE UM UTILIZADOR
